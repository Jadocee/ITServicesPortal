...
public enum Category {
    ...
    WONTLOAD("Won't load at all", BaseCategory.SOFTWARE), POWER("Computer won't turn on", BaseCategory.HARDWARE),
    BLUESCREEN("Computer \"Blue screens\"", BaseCategory.HARDWARE), DRIVE("Disk Drive", BaseCategory.HARDWARE),
